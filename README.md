...
## commands to create s3 bucket in CLI
...
## links to static sites

# CLI: https://hw1-html-cli.s3.eu-central-1.amazonaws.com/index.html

# Console: https://hw1-html-console.s3.eu-central-1.amazonaws.com/index.html
